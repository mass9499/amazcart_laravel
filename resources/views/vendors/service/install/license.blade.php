...
<div class="single-report-admit">
    <div class="card-header">
        <h2 class="text-center text-uppercase color-whitesmoke" >{{ __('service::install.license_verification') }} | <a target="_blank" href="https://bit.ly/2QCCRlD">NULLED scriptzzz!</a>
        </h2>
